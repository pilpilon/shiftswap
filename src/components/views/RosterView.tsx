                                    ...
                                    {addingDate === dateString && (
                                        ...
                                        >
                                            ...
                                            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden mb-3">
                                                ...
                                                <div className="grid grid-cols-[auto_72px_56px_24px] gap-1.5 px-3 py-2 bg-slate-100 text-xs font-semibold text-slate-500">
                                                    <span>תפקיד</span>
                                                ...
                                                <div className="divide-y divide-slate-100">
                                                    {roleRows.map((row, idx) => (
                                                        <div
                                                            key={idx}
                                                            className="grid grid-cols-[auto_72px_56px_24px] gap-1.5 px-3 py-2 items-center"
                                                        >
                                                            {/* Role name */}
                                                            <div>
                                                                <select
                                                            ...
                                                            {/* Skill level — icon toggle buttons */}
